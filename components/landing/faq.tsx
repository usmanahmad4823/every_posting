...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Pro Monthly gives you 150 generations per month for $19/mo. Pro Yearly provides 1,800 generations per year for $190/yr, giving you approximately 2 months free (saving $38/year).',
    },
    {
