...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'The Lifetime Deal gives you one-time permanent access to EveryPosting for a single payment of $199 with no monthly recurring fees. There are only 100 spots reserved for our initial launch.',
    },
    {
