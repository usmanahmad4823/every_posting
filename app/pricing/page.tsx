...
export default function PricingPage() {
  ...
  return (
    <div className="pt-20 sm:pt-28 pb-16 sm:pb-24 bg-[#FFF5F9] min-h-screen relative overflow-hidden text-[#0A0A0C]">
      ...
      <div className="absolute top-12 left-1/2 -translate-x-1/2 whitespace-nowrap text-6xl sm:text-[120px] lg:text-[150px] font-black uppercase text-[#FF529A]/[0.07] tracking-widest select-none pointer-events-none z-0">
        PRICING PLAN
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
          ...
          <h1 className="text-2xl sm:text-5xl font-black text-[#0A0A0C] tracking-tight leading-tight">
          ...
          <p className="mt-3 text-[#52525B] text-xs sm:text-lg font-medium leading-relaxed">
          ...
          {user?.loggedIn && (
            <div className="mt-5 inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white border border-[#FFC2DA] shadow-xs text-xs font-bold text-[#0A0A0C]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch max-w-5xl mx-auto">
          {/* Card 1: Free Starter */}
          <div className="rounded-2xl bg-white/70 border border-[#FFC2DA] hover:border-[#FF529A]/60 transition-all duration-300 p-5 sm:p-6 flex flex-col justify-between backdrop-blur-2xl shadow-lg hover:shadow-xl relative overflow-hidden group">
          ...
          <div className="rounded-2xl bg-gradient-to-b from-white via-pink-50/70 to-white border-2 border-[#FF529A] transition-all duration-300 p-5 sm:p-6 flex flex-col justify-between backdrop-blur-2xl shadow-[0_8px_30px_rgba(255,82,154,0.18)] relative overflow-hidden group scale-[1.01]">
          ...
          {/* Card 3: Pro Yearly (BEST VALUE CARD - EXACT SAME PINK GRADIENT BUTTON AS MONTHLY) */}
          <div className="rounded-2xl bg-white/70 border border-purple-200 hover:border-[#FF529A]/60 transition-all duration-300 p-5 sm:p-6 flex flex-col justify-between backdrop-blur-2xl shadow-lg hover:shadow-xl relative overflow-hidden group">
