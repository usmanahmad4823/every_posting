      ...
      <div className="w-full lg:w-1/2 min-h-screen flex flex-col justify-between p-6 sm:p-10 lg:p-12 bg-white relative">
        ...
        <div className="my-auto max-w-sm w-full mx-auto">
          ...
          <div className="text-center mb-5">
            <div className="hidden lg:inline-flex items-center justify-center w-11 h-11 rounded-xl bg-pink-50 text-[#FF529A] mb-2">
          ...
          {/* Error & Info Alerts */}
          {errorMsg && (
            <div className="mb-3.5 p-3 rounded-xl bg-rose-50 border border-rose-200 text-rose-700 text-xs flex items-center gap-2 font-medium">
          ...
          {googleNotice && (
            <div className="mb-3.5 p-3 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-xs flex items-center gap-2 font-medium">
          ...
          <form onSubmit={handleSignUp} className="space-y-2.5">
            {/* Full Name Input */}
            <div>
              <label className="block text-[11px] font-bold text-[#1A1A2E] mb-0.5 uppercase tracking-wider">Full Name</label>
              <div className="relative flex items-center bg-[#F8FAFC] border border-[#E2E8F0] focus-within:border-[#FF529A] focus-within:ring-2 focus-within:ring-[#FF529A]/10 rounded-xl px-3.5 py-2 transition-all">
                <User className="w-4 h-4 text-[#A1A1AA] shrink-0 mr-2.5" />
                <input
                  type="text"
                  name="fullName"
                  id="fullName"
            ...
            {/* Email Input */}
            <div>
              <label className="block text-[11px] font-bold text-[#1A1A2E] mb-0.5 uppercase tracking-wider">Email</label>
              <div className="relative flex items-center bg-[#F8FAFC] border border-[#E2E8F0] focus-within:border-[#FF529A] focus-within:ring-2 focus-within:ring-[#FF529A]/10 rounded-xl px-3.5 py-2 transition-all">
            ...
            <div>
              <label className="block text-[11px] font-bold text-[#1A1A2E] mb-0.5 uppercase tracking-wider">Password</label>
              <div className="relative flex items-center bg-[#F8FAFC] border border-[#E2E8F0] focus-within:border-[#FF529A] focus-within:ring-2 focus-within:ring-[#FF529A]/10 rounded-xl px-3.5 py-2 transition-all">
            ...
            <div>
              <label className="block text-[11px] font-bold text-[#1A1A2E] mb-0.5 uppercase tracking-wider">Confirm Password</label>
              <div className="relative flex items-center bg-[#F8FAFC] border border-[#E2E8F0] focus-within:border-[#FF529A] focus-within:ring-2 focus-within:ring-[#FF529A]/10 rounded-xl px-3.5 py-2 transition-all">
                <Lock className="w-4 h-4 text-[#A1A1AA] shrink-0 mr-2.5" />
                <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#FF529A] hover:bg-[#E04385] text-white font-bold text-xs py-3 rounded-full shadow-md shadow-pink-500/20 transition-all active:scale-[0.99] flex items-center justify-center gap-2 mt-2.5"
            >
              {loading ? (
          ...
          {/* Bottom Nav Link */}
          <div className="mt-5 text-center text-xs text-[#6B7280] font-medium">
        ...
        {/* Footer */}
        <div className="text-center text-[10px] text-[#A1A1AA] font-medium mt-auto pt-3">
